...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='checkcash.conf'
CONFIGFOLDER='/root/.checkcash'
COIN_DAEMON='/usr/local/bin/checkcashd'
COIN_CLI='/usr/local/bin/checkcash-cli'
COIN_REPO='https://github.com/CheckCash/CheckCash/releases/download/1.0.3.1/CheckCash.Ubuntu.16.tar.gz'
SENTINEL_REPO='https://github.com/CheckCash/sentinel.git'
COIN_NAME='CheckCash'
COIN_PORT=8890
RPC_PORT=8800
